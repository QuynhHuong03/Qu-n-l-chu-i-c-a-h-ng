                ...
                <div class="col-md-4">
                        <div class="order-summary">
                            ...
                            <div class="total-section">
                                ...
                                <input type="text" readonly name="tongtiendon" class="total" />
                                <input type="hiden" readonly readonly oninput="document.querySelector('input[name=tongtiendon]').value = this.value" />
                            </div>
